 ...
 */
public class AccelerationSensor extends SensorBase {
    private static AccelerationSensor instance = new AccelerationSensor();

    private AccelerationSensor() {
    }

    public static AccelerationSensor getInstance() {
        return instance;
    }
