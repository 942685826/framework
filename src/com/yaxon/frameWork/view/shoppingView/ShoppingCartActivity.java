package com.yaxon.frameWork.view.shoppingView;
...
public class ShoppingCartActivity extends Activity {
    ...
    private void setAdapter() {
        // 设置适配器
        mShoppingCartLv.setAdapter(new CommonAdapter<GoodsModel>(mData, this, R.layout.shopping_cart_item) {
            @Override
            public void convert(CommonViewHold commonViewHold, GoodsModel item) {
                ImageView imageView = commonViewHold.getView(R.id.iv_shopping_cart_item);
                imageView.setImageBitmap(item.getmGoodsBitmap());
                RelativeLayout relativeLayout = commonViewHold.getView(R.id.rl_shopping_cart_item);
