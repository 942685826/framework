...
public class HorizontalStepView extends LinearLayout implements HorizontalStepsViewIndicator.OnDrawIndicatorListener{
    ...
    private int mUnComplectedTextColor = getResources().getColor(R.color.uncompleted_color);//定义默认未完成文字的颜色;
    private int mComplectedTextColor = getResources().getColor(R.color.completed_color);//定义默认完成文字的颜色;
