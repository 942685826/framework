...
public class HorizontalStepsViewIndicator extends View {
    ...
    private int mUnCompletedLineColor = getResources().getColor(R.color.uncompleted_color);//定义默认未完成线的颜色
    private int mCompletedLineColor = getResources().getColor(R.color.completed_color);//定义默认完成线的颜色
    ...
    private void init() {
        ...
        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.img_1);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.img_2);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.img_3);//未完成的icon
        mLastCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.img_4);//终点已完成的icon
        mLastUnCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.img_5);//终点未完成的icon
    }
